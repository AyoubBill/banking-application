...
import { findAllByUserId } from '../fn/transaction/find-all-by-user-id';
import { FindAllByUserId$Params } from '../fn/transaction/find-all-by-user-id';
...
export class TransactionService extends BaseService {
  ...
  static readonly Delete1Path = '/transactions/delete/{transaction-id}';
